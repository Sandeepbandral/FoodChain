...
public class Filter_DietaryChildAdapter extends RecyclerView.Adapter<Filter_DietaryChildAdapter.ViewHolder> {
    ...
    public Filter_DietaryChildAdapter(Context context, FilterOptionsInterface filterOptionsInterface, ArrayList<FilterOptionsModel> filterOptionsList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.listitem_filter_dietary_child, parent, false);
