...
public class SkipRegisterActivity extends BaseActivity implements LoginAndRegisterInterface {
    ...
    protected Context getActivityContext() {
        return SkipRegisterActivity.this;
    }
    ...
    protected void onDestroy() {
        try {
            loginOrRegisterPresenter.detachView();
        } catch (Exception e) {
        }
        super.onDestroy();
    }
    ...
    public void onSuccess_LoginOrRegister(String message, UserDetailsResponse userDetailsResponse, String name, boolean isFBLogin) {
        ...
        showToast("Thanks for registering with Magic. Verification link has been sent to your registered email address. " +
